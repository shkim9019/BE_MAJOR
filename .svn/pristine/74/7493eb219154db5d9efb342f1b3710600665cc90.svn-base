...
public class BookingListDaoMain {

	public static void main(String[] args) {
		BookingListDao dao = new BookingListDao();
		...
		do {
			...
			case "R":
				...
				BookingListVO retrieveVO = dao.getSearchData(dataScanner);
				List<BookingListVO> list = (List<BookingListVO>) dao.do_retrieve(retrieveVO);
				// 출력
				dao.disp(list);
