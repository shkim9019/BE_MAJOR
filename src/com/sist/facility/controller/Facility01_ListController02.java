...
public class Facility01_ListController02 implements Initializable {
	...
	public void MoveToDetail03(ActionEvent event) {
		try {
			...
			Parent root = FXMLLoader.load(getClass().getResource("/com/sist/facility/view/Facility02_Infomation003.fxml"));
			Scene scene = new Scene(root);
	...
	public void MoveToDetail04(ActionEvent event) {
		try {
			...
			Parent root = FXMLLoader.load(getClass().getResource("/com/sist/facility/view/Facility02_Infomation004.fxml"));
			Scene scene = new Scene(root);
