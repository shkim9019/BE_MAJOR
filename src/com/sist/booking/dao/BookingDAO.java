...
//List�? 콘솔?�� 출력
	...
	public BookingVO getInputCode2(String tfArea, String tfDate) {
		BookingVO outVO = null;

		// 문자 공백제거
		String area = tfArea.trim();
		String date = tfDate.trim();

		outVO = new BookingVO();

		// 입력받은 tfArea,tfDate VO에 로드.
		outVO.setFacilityArea(area);
		outVO.setBookingDate(date);
		System.out.println("입력:" + outVO);
		return outVO;
	}
